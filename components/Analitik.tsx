        ...
        <div className="animate-fade-in-up">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
                ...
                <div className="flex items-center gap-3 sm:ml-auto">
                    <PdfExportButton targetRef={contentRef} fileName="Analitik_Pembelajaran" />
                     <label className="text-sm font-medium text-gray-500 dark:text-gray-400 mr-2">Filter Kelas:</label>
                    <select
                        value={selectedClass}
                        onChange={(e) => setSelectedClass(e.target.value)}
                        className="p-2 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-200 border border-gray-300 dark:border-gray-600 rounded-md"
                    >
                        {classList.map(c => (
             ...
             <div ref={contentRef} className="flex flex-col lg:flex-row lg:space-x-8 space-y-8 lg:space-y-0" key={selectedClass}>
