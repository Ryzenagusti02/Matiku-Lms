...
const MainLayout: React.FC<MainLayoutProps> = ({ 
    ...
    const renderPage = () => {
        switch (currentPage) {
            ...
            case 'papan-matematika':
                return <MathCanvas user={user} />;
            case 'ai-assistant':
    ...
    return (
        <div className="flex h-screen overflow-hidden bg-gray-50 dark:bg-gray-900">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                />
                <main ref={mainContentRef} className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 dark:bg-gray-900 p-6">
                    {renderPage()}
                </main>
            </div>
        </div>
