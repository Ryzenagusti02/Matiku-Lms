    ...
    return (
        <div className="animate-fade-in-up">
            <div className="flex justify-between items-center mb-6">
                <h3 className="text-3xl font-medium text-gray-900 dark:text-white">Penugasan</h3>
                <div className="flex gap-2">
                    <PdfExportButton targetRef={contentRef} fileName="Penugasan" />
                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        {assignments.map(assignment => (
                            <tr key={assignment.id} className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td className="px-6 py-4 text-right">
                                    <button onClick={() => openSubmissionsModal(assignment)} className="text-gray-500 dark:text-gray-400 hover:text-green-400 mr-4" title="Lihat Submisi"><EyeIcon className="w-5 h-5" /></button>
                                    <button onClick={() => openModal(assignment)} className="text-gray-500 dark:text-gray-400 hover:text-blue-400 mr-4" title="Edit"><EditIcon className="w-5 h-5" /></button>
                                    <button onClick={() => handleDelete(assignment)} className="text-gray-500 dark:text-gray-400 hover:text-red-400" title="Hapus"><TrashIcon className="w-5 h-5" /></button>
                                </td>
                            </tr>
                        ))}
                ...
                <div className="fixed inset-0 bg-black bg-opacity-70 z-50 flex justify-center items-center p-4">
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-lg">
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">{currentAssignment.id ? 'Edit Tugas' : 'Tugas Baru'}</h2>
                        ...
                        <div className="space-y-4">
                            ...
                            {assignmentFile && <p className="text-sm text-gray-500 dark:text-gray-400">File dipilih: {assignmentFile.name}</p>}
                        </div>
            ...
            {isSubmissionsModalOpen && selectedAssignment && (
                <div className="fixed inset-0 bg-black bg-opacity-70 z-50 flex justify-center items-center p-4">
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col">
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">Submisi Tugas: {selectedAssignment.title}</h2>
